 ...
 ?>
	...
	<div class="container" id="locat-p">
			<div class="col-md-12">
				<div class="row" id="locat1">
					...
					<d
					iv class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
	...
	$a = "SELECT * FROM property where Address like '".$add."' or Type like '".$type."' or (`Price` >=$minprice && `Price` <=$maxprice)";
			...
			if ($run==true) 
			{
				...
				?>
					<section id="rent">
						<div class="container-md property" style="margin-top: 119px !important;">
